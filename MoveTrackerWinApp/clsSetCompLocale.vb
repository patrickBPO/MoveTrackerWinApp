...
Public Class clsSetCompLocale
    Public Function GetLocale() As Boolean
        glbHWID = MakeHWID()
        If Not GetRegKyVal(glbCPU) Then
            Return False
        Else
            Return True
        End If
    ...
    Friend Function GetRegKyVal(ByVal cpuId As String) As Boolean
        ...
        Try
            ...
            Else
                ...
                regKey = Microsoft.Win32.Registry.ClassesRoot.OpenSubKey("Software\Movement\", True)
